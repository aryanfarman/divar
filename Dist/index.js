...
const crawlDivar=() => {
    request('https://divar.ir/s/mashhad/car', (error: any, response: { statusCode: number; }, html: string | Node | Node[] | Buffer )=>{
...
function getCars(carBrand = brands_1.brands[Math.floor(Math.random() * (brands_1.brands.length))].name) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield (0, got_1.default)(`https://api.divar.ir/v8/web-search/mashhad/car/${carBrand}`);
